...
function updateCharacteristicValue(oldState, action) {
    ...
    switch (action.characteristic.name) {
        case "Temperature":
            ...
            aggregator.append_datapoint(action.characteristic.value[0], "temperature")
        ...
        case "Pressure":
            ...
            aggregator.append_datapoint(action.characteristic.value[0], "pressure")
        ...
        case "Humidity":
            ...
            aggregator.append_datapoint(action.characteristic.value[0], "humidity")
