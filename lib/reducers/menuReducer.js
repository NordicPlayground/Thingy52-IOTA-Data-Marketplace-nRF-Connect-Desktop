...
function updateCharacteristicValue(oldState,action){
    ...
    switch (action.characteristic.name){
        case "Temperature":
            ...
            break;
        case "Pressure":
            console.log('pressure: ', action.characteristic.value );
            characteristics.pressure = action.characteristic.value[0] + "." + action.characteristic.value[1]
            state.set('characteristics', characteristics)
            break;
        case "Humidity":
            characteristics.humidity = action.characteristic.value[0] + "." + action.characteristic.value[1]
            state.set('characteristics', characteristics)
            break;
    }
    return state
